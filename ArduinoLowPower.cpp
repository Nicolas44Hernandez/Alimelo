...
void ArduinoLowPowerClass::deepSleep(uint8_t hours, uint8_t minutes, uint8_t seconds)
{
	setAlarmIn(hours, minutes, seconds);
	sleep();
}

void ArduinoLowPowerClass::setAlarmIn(uint8_t hours, uint8_t minutes, uint8_t seconds) 
{
  if (!rtc.isConfigured()) {
